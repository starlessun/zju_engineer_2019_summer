...
class MoveBaseSquare():
    def __init__(self):
        ...
        waypoints.append(Pose(Point(0.0, 0.0, 0.0), norminal_quaternion))
        waypoints.append(Pose(Point(0.0, 1.0, 0.0), norminal_quaternion))
        waypoints.append(Pose(Point(0.0, 2.0, 0.0), norminal_quaternion))
        waypoints.append(Pose(Point(0.0, 3.0, 0.0), norminal_quaternion))

        waypoints.append(Pose(Point(1.0, 0.0, 0.0), norminal_quaternion))
        waypoints.append(Pose(Point(1.0, 1.0, 0.0), norminal_quaternion))
        waypoints.append(Pose(Point(1.0, 2.0, 0.0), norminal_quaternion))
        waypoints.append(Pose(Point(1.0, 3.0, 0.0), norminal_quaternion))

        waypoints.append(Pose(Point(2.0, 0.0, 0.0), norminal_quaternion))
        waypoints.append(Pose(Point(2.0, 1.0, 0.0), norminal_quaternion))
        waypoints.append(Pose(Point(2.0, 2.0, 0.0), norminal_quaternion))
        waypoints.append(Pose(Point(2.0, 3.0, 0.0), norminal_quaternion))

        waypoints.append(Pose(Point(3.0, 0.0, 0.0), norminal_quaternion))
        waypoints.append(Pose(Point(3.0, 1.0, 0.0), norminal_quaternion))
        waypoints.append(Pose(Point(3.0, 2.0, 0.0), norminal_quaternion))
        waypoints.append(Pose(Point(3.0, 3.0, 0.0), norminal_quaternion))


        obstaclepoints.append(Pose(Point(2.0, 1.0, 0.0), norminal_quaternion))
        obstaclepoints.append(Pose(Point(2.0, 2.0, 0.0), norminal_quaternion))
        obstaclepoints.append(Pose(Point(2.0, 3.0, 0.0), norminal_quaternion))
